...
def choose_file(request, root_path):
    """
    交互式(多)文件选择
    后端遍历路径下的文件名 并传至前端候选
    ...
    return HttpResponse(json.dumps(path_context, ensure_ascii=False),
...
def showdata(request, df=df_col):
